...
class InstaWP_Setting {
	...
	public static function get_plugin_nav_items() {
		...
		$instawp_nav_items = array(
			...
			'manage' => array(
				'label' => esc_html__( 'Manage', 'instawp-connect' ),
				'icon'  => '<svg class="mr-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			'sync'       => array(
				'label' => esc_html__( 'Sync (Beta)', 'instawp-connect' ),
