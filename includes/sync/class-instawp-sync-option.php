...
class InstaWP_Sync_Option {
	...
	private function is_protected_option( $option ): bool {
		$excluded_options = array( 'cron', 'instawp_api_options', 'siteurl', 'home', 'permalink_structure', 'rewrite_rules', 'recently_activated', 'active_plugins', 'theme_switched', 'sidebars_widgets', 'theme_switch_menu_locations', 'recovery_mode_email_last_sent', 'recovery_keys' );
