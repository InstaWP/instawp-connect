...
class InstaWP_Backup_Database
{
    ...
    public function instawp_archieve_database_info( $databases, $data ) {
    ...
    public function backup_database( $data,$task_id = '' ) {
        ...
        try {
            ...
            add_filter('instawp_exclude_db_table', array( $this, 'exclude_table' ),10,2);
            $exclude = array();
            $exclude = apply_filters('instawp_exclude_db_table',$exclude, $data);
            $include = array();
            $include = apply_filters('instawp_include_db_table',$include, $data);
            ...
            add_filter('instawp_archieve_database_info', array( $this, 'instawp_archieve_database_info' ), 10, 2);
            $databases = array();
            $databases = apply_filters('instawp_archieve_database_info', $databases, $data);
            ...
            foreach ( $databases as $sql_info ) {
                ...
                $dump = new InstaWP_Mysqldump($host, $database_name, $user, $pass, $is_additional_db, $dumpSettings);
