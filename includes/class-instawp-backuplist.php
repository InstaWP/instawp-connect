...
class InstaWP_Backuplist
{
    ...
    public static function get_backuplist( $list_name='' ) {
        ...
        $list = apply_filters('instawp_get_backuplist',$list,$list_name);
        return $list;
    }
    ...
    public static function add_new_upload_backup( $task_id,$backup,$time,$log='' ) {
        ...
        $backup_data['local']['path'] = InstaWP_Setting::get_backupdir();
        ...
        $backup_list = apply_filters('get_instawp_backup_list_name',$backup_list,$task_id,$backup_data);
