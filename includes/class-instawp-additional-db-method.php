...
class InstaWP_Additional_DB_Method
{
    private $dbuser;
    private $dbpass;
    private $dbhost;
    ...
    public function instawp_parse_db_host( $host ) {
        $port    = null;
        $socket  = null;
        $is_ipv6 = false;
    ...
    public function instawp_do_connect( $allow_bail = true ) {
        ...
        if ( $this->use_mysqli ) {
            ...
            if ( $host_data = $this->instawp_parse_db_host( $this->dbhost ) ) {
            ...
            if ( $this->dbh->connect_errno ) {
                ...
                if ( $attempt_fallback ) {
                    ...
                    return $this->instawp_do_connect( $allow_bail );
                }
            }
        }
        else {
    ...
    public function instawp_show_additional_databases(){
