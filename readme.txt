...
- Fixed: The wp-content folder can no longer be excluded on the Exclude step, so "Select All" can no longer produce a staging site with no themes, plugins or uploads.
