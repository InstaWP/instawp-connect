...
defined( 'INSTAWP_PLUGIN_VERSION' ) || define( 'INSTAWP_PLUGIN_VERSION', '0.1.0.27' );
...
function instawp_create_migration_manually() {
...
//      instawp_create_migration_manually();

		//delete_option( 'instawp_files_offset' );
		echo "<pre>";
		print_r( get_option( 'instawp_files_offset' ) );
		echo "</pre>";
