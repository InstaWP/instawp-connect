...
//			'is_reserved' => false
//		);
//		$sites_response = InstaWP_Curl::do_curl( 'sites', $sites_args );
//
//		echo "<pre>";
//		print_r( $sites_response );
//		echo "</pre>";

//		$site_id               = 369;
//		$sftp_details_response = InstaWP_Curl::do_curl( "sites/{$site_id}/sftp-details", [], [], false );


		$wp_root_dir = '/Volumes/Devroot/InstaWP/instawp-main';
//		$skip_folders     = [];
...
//		};
//		$directory        = new RecursiveDirectoryIterator( $wp_root_dir, RecursiveDirectoryIterator::SKIP_DOTS | RecursiveDirectoryIterator::FOLLOW_SYMLINKS );
...
//
//		try {
//			$limitedIterator = new LimitIterator( $iterator, 0, BATCH_SIZE );
//		} catch ( Exception $e ) {
//			echo "<pre>";
