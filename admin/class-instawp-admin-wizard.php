...
class InstaWP_Admin_Wizard {
    ...
    public function instawp_admin_wizard_two_btn( $btn_args ) {        
        ...
        <div class="home-screen-backup-customize-options">
        ...
        <!-- Customize options checkbox div -->
        <div class="home-screen-backup-customize-checkboxes">
            <div class="customize-checkbox-wrap">
                ...
                <div class="customize-checkboxes-tooltip-wrap">
                    ...
                    <span class="customize-checkboxes-tooltip-data" style="display:none;">
                        <?php _e('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod'); ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="instawp-wizard-btn-wrap button-2">            
            <a class="instawp-wizard-btn" id="instawp_quick_backup_btn" data-backup-type="1" href="javascript:void(0)">
                <span><?php echo esc_html( $btn_args['button_1']['label'] ); </span>
                <p>( echo esc_html( $btn_args['button_1']['desc'] ); )</p>
            </a>
