<?php if ( ! empty( $events ) ) : ?>
    <?php foreach ( $events as $event ) : ?>
        <?php
            ...
            $label_classes    = [ $event_status, '[&.completed1]:text-red-500' ];
            $label_attributes = '';
