        ...
        <tr>
            ...
            <td class="whitespace-nowrap px-3 py-3 text-center font-medium text-sm text-grayCust-300">
                <div class="flex flex-col items-center">
                    <div class="text-sm font-medium !px-3 !py-1 !m-0 !shadow-none !border-0 rounded-full synced_status <?php echo esc_attr( join( ' ', $label_classes ) ); ?> [&.pending]:bg-sky-200 [&.pending]:text-sky-800 [&.error]:bg-red-200 [&.error]:text-red-800 [&.invalid]:bg-yellow-200 [&.invalid]:text-yellow-800 [&.completed]:bg-green-200 [&.completed]:text-green-900" <?php echo $label_attributes; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscape ?>><?php echo esc_html( ucfirst( $event_status ) ); ?></div>
