    ...
    <?php foreach ( $events as $event ) : ?>
        ...
        <tr>
            ...
            <div class="flex flex-col items-center">
                ...
                <?php if( isset($event_row->log) && $event_row->log !='' ): ?>
                    <div class="hint--top hint--low" aria-label="<?php echo $event_row->log; ?>">
                    ...
                    <div>
                <?php endif ?>
                <!-- <div class="py-1 px-4 inline-block rounded-full text-primary-900 font-medium synced_status <?php echo $status.' '.$label_class; ?>" <?php echo $label_attributes; ?>>
