	...
	<?php if ( $update_available ) : ?>
        <div class="pb-4 flex items-center justify-center">
            <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 text-left w-full" role="alert">
                <p>
					<?php printf(
						wp_kses_post( __( 'A new version of InstaWP Connect is available. <a href="#" class="underline hover:text-yellow-900 instawp-update-plugin" data-plugin="%s">Update now</a> to ensure you have the latest features and security updates.', 'instawp-connect' ) ),
