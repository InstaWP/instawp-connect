                        ...
                        <table class="min-w-full divide-y divide-gray-300">
							...
							<?php foreach ( $staging_sites as $site ) :
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-6 font-medium text-xs text-grayCust-300">
                                        <span><?php echo esc_html( $username ); ?></span>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-8 font-medium text-xs text-grayCust-300 flex items-center">
                                        <span><?php echo esc_html( $password ); ?></span>
                                        <!-- <img src="img/off-eye.svg" class="ml-2 cursor-pointer" alt="">-->
                                    </td>
                                    <td class="whitespace-nowrap text-center px-6 py-6 font-medium text-xs text-grayCust-300">
                                        <span><?php echo esc_html( $datetime ); ?></span>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-6 font-medium text-xs text-grayCust-300">
                                        <div class="flex items-center justify-center">
                                            <a href="<?php echo esc_url( $auto_login_url ); ?>" target="_blank" type="button" class="relative flex items-center px-2.5 w-11 h-9 lg:px-3 rounded-l-md border border-grayCust-350 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-0 focus:border-grayCust-350">
                                            ...
                                            <button type="button" class="-ml-px relative inline-flex items-center px-2 w-11 h-9 lg:px-3 border border-grayCust-350 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-0 focus:border-grayCust-350">
                                            ...
                                            <button type="button" class="-ml-px relative inline-flex items-center px-2 rounded-r-md w-10 h-9 lg:px-3 border border-grayCust-350 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-0 focus:border-grayCust-350">
