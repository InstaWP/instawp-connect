                        ...
                        <div class="panel mt-6 block">
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                                <div class="min-w-full divide-y divide-gray-300">
                                    <div class="bg-gray-50 flex flex-row justify-between p-4">
                                        <div>
                                            <div class="text-left text-sm font-medium text-grayCust-900 font-bold"><?php esc_html_e( 'Files', 'instawp-connect' ); ?></div>
                                        </div>
                                        <div class="flex flex-row gap-5">
                                            <div class="text-left text-sm font-medium text-grayCust-900 hidden">
                                                <input type="checkbox" id="instawp-files-select-all" class="instawp-checkbox !mt-0 !mr-1 rounded border-gray-300 text-primary-900 focus:ring-primary-900" disabled="disabled">
                                                <label for="instawp-files-select-all"><?php esc_html_e( 'Select All', 'instawp-connect' ); ?></label>
                                            </div>
                                            <!-- <button type="button" class="bg-white pddy-2 pdx-2 borghder rounhded shadgow">
