                                ...
                                <div class="min-w-full divide-y divide-gray-300">
                                    <div class="bg-gray-50 flex flex-row items-center justify-between p-4">
                                        ...
                                        <div class="flex flex-row items-center justify-between gap-5">
                                            ...
                                            <div class="text-left text-sm font-medium text-grayCust-900 flex flex-row items-center justify-between gap-1 cursor-pointer instawp-sort-by" data-sort="ascending">
                                                ...
                                                <?php esc_html_e( 'Sort By', 'instawp-connect' ); ?>
                                            </div>
